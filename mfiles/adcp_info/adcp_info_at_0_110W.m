...
basedir1 = '../../tao_array/toApril2016/ADCP_from_Brian_Lake/processed/';
basedir2 = '../../../tao_array/toApril2016/ADCP_from_Brian_Lake/processed/';

filenames = {'adcp0n110w_hr_5m_array_EA020_2013Mar29-2014Jun21.mat'};

if exist([basedir1 filenames{1}],'file') == 2
    disp('using basedir1')
    adcpinfo.filenames = {[basedir1 filenames{1}]};
elseif exist([basedir2 filenames{1}],'file') == 2
    disp('using basedir2')
    adcpinfo.filenames = {[basedir2 filenames{1}]};
end
adcpinfo.numfiles = 1;
...
for dd = 1:adcpinfo.numfiles
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % special instructions for CA018. The data that I want to parse in is
...
%
% Note: if there is no additional current meter data, this section can just
% be NaNed out. The main part of the code works with just additional ADCP
% data or no additional data at all.
