function [Amo] = monthly_average(A)
% monthly_average loops through every month in a time series,
% and averages each month's data into a single point.
%
% [Amo] = monthly_average(A)
%
% A is your input structure. It MUST have a field A.time
% Amo is monthly averages of all of the fields in A
%
% Note: If you data has dt < 1 day, this code may take a very long time to
% run. It is MUCH quicker to first use bin_average to convert high
